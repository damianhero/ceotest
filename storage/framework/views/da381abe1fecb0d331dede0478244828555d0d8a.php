            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <h6 class="card-subtitle">¿Seguro que desea eliminar este producto?</h6>
                        <form class="form-horizontal m-t-20" id="loginform" method="post" action="<?php echo e(url('/admin/delete_productos/'.$productosDetalles->id)); ?>"><?php echo e(csrf_field()); ?>
