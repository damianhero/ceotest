							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="<?php echo e(asset('images/admin/productos/chicas/'.$producto->imagen)); ?>" alt="" />
											<h2>$ <?php echo e($producto->precio); ?></h2>
											<h4><?php echo e($producto->codigo_producto); ?></h4>
											<p><?php echo e($producto->nombre_producto); ?></p>
											<a href="<?php echo e(url('producto/'.$producto->id)); ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
