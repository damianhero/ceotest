            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <form class="form-horizontal m-t-20" id="loginform" method="post" action="<?php echo e(url('/admin/add_categorias')); ?>"><?php echo e(csrf_field()); ?>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="status" class="col-sm-3 text-right control-label col-form-label">Abilitado</label>
                                        <div class="col-sm-1">
