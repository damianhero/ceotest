			...
			<div class="col-md-3 p-5">
				...
				<div class="col-sm-9 pl-0 pt-5 pb-5">
					<div class="features_items"><!--features_items-->
						<h3 class="title text-center">Guía de Transportes</h3>
				...
				<div class="recommended_items"><!--recommended_items-->
						<h3 class="title text-center p-3 pb-5">Tipos de Transportes</h3>
						
							<?php echo $__env->make('layouts.slidercat', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
