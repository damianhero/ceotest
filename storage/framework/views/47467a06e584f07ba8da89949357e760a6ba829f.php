                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a href="<?php echo e(url('/admin/edit_transportes/'.$producto->id)); ?>" class="btn btn-warning btn-mini">Editar</a> 
                                                    <a href="<?php echo e(url('/admin/delete_transportes/'.$producto->id)); ?>" class="btn btn-danger btn-mini">Eliminar</a>
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="col-md-7 p-2">
                                                        <div class="card">
                                                            <table class="table">
                                                                <thead>
                                                                    <tr>
                                                                    <th scope="col"><b>Descripción Breve</b></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                        ...
                                                        <div class="card">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                    <td><?php echo e($producto->categoria_nombre); ?></td>
                                                                    <td><?php echo e($producto->email); ?></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="card">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                    <td><?php echo e($producto->telefono); ?></td>
                                                                    <td><?php echo e($producto->tipo_servicio); ?></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                        <div class="card">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                    <td><?php echo e($producto->descripcion2); ?></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
