...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('images/admin/edilogo.png')); ?>">
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                ...
                <strong><?php echo session('flash_message_error'); ?>
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong><?php echo session('flash_message_success'); ?>
                ...
                <?php endif; ?>
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo e(asset('images/admin/edilogo.png')); ?>" alt="logo" /></span>
                        <span class="db"><img src="<?php echo e(asset('images/admin/edilogo2.png')); ?>" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="post" action="<?php echo e(url('admin')); ?>"><?php echo e(csrf_field()); ?>
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i>¿Olvidaste tu contaseña?</button>
