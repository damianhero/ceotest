                                        ...
                                        <div class="row">
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Usuarios Totales</small>
                                                </div>
                                            </div>
                                             <!--div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                            ...
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Ventas Totales</small>
                                                </div>
                                            </div>
                                             <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   <i class="fa fa-tag m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5">954</h5>
                                                   <small class="font-light">Ordenes Totales</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Ord. Pendientes</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Ord. en Proceso</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="<?php echo e(asset('assets/images/users/1.jpg')); ?>" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="<?php echo e(asset('assets/images/users/4.jpg')); ?>" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="<?php echo e(asset('assets/images/users/5.jpg')); ?>" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="<?php echo e(asset('assets/images/users/1.jpg')); ?>" alt="user"></div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="<?php echo e(asset('assets/images/users/2.jpg')); ?>" alt="user"></div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="<?php echo e(asset('assets/images/users/3.jpg')); ?>" alt="user"></div>
                                            <div class="chat-content">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="<?php echo e(asset('assets/images/background/img4.jpg')); ?>" class="img-fluid">
                                    </div>
                                </div>
