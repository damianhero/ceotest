...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-success">
            <div class="auth-box bg-success border-top border-secondary">
                <div id="loginform">
                ...
                <?php endif; ?>
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo e(asset('images/admin/logowhite.png')); ?>" alt="logo" /></span>
                        <span class="db"><img src="<?php echo e(asset('images/admin/gdt.png')); ?>" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-success float-right" style="background-color:#1f8d5d;" type="submit">Ingresar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
