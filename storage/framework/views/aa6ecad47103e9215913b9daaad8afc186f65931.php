            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <form enctype="multipart/form-data"  class="form-horizontal m-t-20" id="loginform" method="post" action="<?php echo e(url('/admin/edit_categorias/'.$categoriaDetalles->id)); ?>"><?php echo e(csrf_field()); ?>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <?php if(!empty($categoriaDetalles->imagen)): ?>
                                            <img style="width:100px;" src="<?php echo e(asset('images/admin/categorias/chicas/'.$categoriaDetalles->imagen)); ?>">
                                            <a href="<?php echo e(url('admin/delete_categorias_imagen/'.$categoriaDetalles->id)); ?>">Eliminar Imagen</a>
                                            <?php endif; ?>
                                            <input hidden name="imagen_actual" value="<?php echo e($categoriaDetalles->imagen); ?>">
