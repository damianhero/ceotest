                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a href="{{ url('/admin/edit_clientes/'.$cliente->id) }}" class="btn btn-primary btn-mini">Editar</a> 
                                                    <a id="delCat" href="{{ url('/admin/delete_clientes/'.$cliente->id) }}" class="btn btn-danger btn-mini">Eliminar</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            <!--tr>
